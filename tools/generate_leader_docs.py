...
def recurring_paragraphs(focus: str, count: int) -> list[str]:
    base = [
        ...
        f"{focus}这块跟分工是绑定的：崔昊晨管采集，罗昆昊管清洗和存储，兰玉杰管趋势分析算法，王永成管前端展示和用户文档，郭子凌管测试和进度月报，组长我管整体架构、核心文档、评审把关和最终归档。各管各的，接口对齐就行。",
    ]
            ...
            Section(
                ...
                tables=[
                    (
                        ["阶段", "时间", "主要任务", "责任人", "交付物"],
                        [
                            ["可行性与计划", "2026-06-13 至 2026-06-14", "选题、竞品分析、总体计划", "组长、兰玉杰", "项目开发计划、可行性研究报告"],
                            ["需求分析", "2026-06-14 至 2026-06-16", "需求调研、用例建模、数据要求", "组长、崔昊晨", "软件需求说明书、数据要求说明书"],
                            ["系统设计", "2026-06-16 至 2026-06-18", "架构、概要设计、数据库设计、详细设计", "组长、罗昆昊", "概要设计、数据库设计、详细设计"],
                            ...
                            ["总结答辩", "2026-06-23 至 2026-06-24", "部署验收、总结、演示检查和归档", "组长", "开发总结报告、演示检查材料"],
                        ],
                    )
                ],
            ),
    ...
    return DocSpec(
        ...
        [
            ...
            Section(
                "用户与业务场景",
                [
                    "当前演示版本以组长现场操作为主，重点展示数据源配置、采集、检索、趋势详情和报表下载。管理员、分析员和普通用户三类账号作为后续权限扩展设计，不纳入本次课堂演示必须项。",
                ...
                tables=[
                    (
                        ["用户角色", "主要目标", "关键操作"],
                        [
                            ["组长/演示操作者", "完成课堂演示和数据配置", "配置数据源、启动采集、查看趋势、下载报表"],
...
def meeting_spec() -> DocSpec:
    rows = [
        ...
        ["第3次", "2026-06-22", "组长文档初稿完成", "完成主体文档初稿编写，自查发现部分章节存在套话、需求覆盖不足、图1缺少正式图表等问题，制定修订方案"],
