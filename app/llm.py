...
def _rule_filter_topics(
    ...
    _GARBAGE_PATTERNS = (
        ...
        r"^[^a-zA-Z\u4e00-\u9fff]{2,}$",
        r"^[a-z]{1,3}$",
        r"^((artificial|intelligence|welcome|home|page|powered|designed|google|language|science|english)|(中文|英文|日本語|한국어|英語))$",
        ...
        r"^.*[。？].+$",
        r'^.{10,}.*[""」].+$',
        r"^(为深入实施|促进生产力|推动人工|重塑人类生产).+",
        r"^.{10,}[-]$",  # 以-结尾的片段如"人工智能-"
        r"^(主要包括|使计算).+",  # 百科句子片段
        r"^人工智能（英语",  # 英文注释条目
        r"^(人工智能（Artificial|人工智能（智能|简称AI)$",
        r"^.{25,}$",  # 极长片段
    )
    import re
